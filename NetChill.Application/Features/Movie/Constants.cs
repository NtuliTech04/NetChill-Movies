namespace NetChill.Application.Features.Movie
{
    public class ConstantText
    {
        ...
        const string movieExistOrNull = "Saving attempt was unsuccessful. Either this object has already " +
                                     "been referenced with the same MovieRef which violates the rule of a " +
                                     "one-to-one relationship between the MovieBaseInfo object and this object, " +
